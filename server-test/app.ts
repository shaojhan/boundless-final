...
import { createFavoriteRouter } from './src/interfaces/routers/favoriteRouter.js';
import { prisma, authService, instrumentService, lessonService, articleService, jamService, userService, cartService, couponService, recommendationService, adminService, favoriteService } from './src/container.js';
...
app.use('/api/favorite', createFavoriteRouter(favoriteService));
